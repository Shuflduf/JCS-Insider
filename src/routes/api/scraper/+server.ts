...
const hardcoded = {"Wednesday":["Soup: Broccoli and Cheddar","Main: Nashville Style Chicken Sandwich, Spicy Spirals(Halal)","Main: Beef Lasagne (Halal)","Pizza: Spicy Buffalo Chicken","Hot Sandwiches: Cod Po’ Boy","Salad: Crispy Chicken Apple Cucumber Salad"],"Monday":["Soup: Chicken Noodle","Main: Chicken Parmesan, Spiral Pasta Rose Sauce (Halal)","Main: Loaded Hot Dog with Fries","Pizza: Cheese","Hot Sandwiches: Croque Monsieur","Salad: Italian Chicken Salad"],"Tuesday":["Soup: Tuscan Sausage, Potato and Kale","Main: Sweet and Sour Chicken, Rice Pilaf","Main: Chicken Enchiladas","Pizza: Beef Peperoni (Halal) ","Hot Sandwiches: Satay Chicken Vietnamese Sub","Salad: Lemongrass Shrimp Vermicelli Bowl"],"Thursday":["No Service"]}
